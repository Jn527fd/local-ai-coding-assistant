...
help: ## Show available commands
	...
	@echo "  make test-frontend     Run frontend lint, typecheck, tests, and build"
...
test-frontend: ## Run frontend lint, typecheck, tests, and build
...
status: ## Show the current implementation phase
	@echo "Single production frontend active"
