...
describe("conversationMapper", () => {
  ...
  it("reads metadata saved by migration builds", () => {
    const conversation = mapBackendConversationToConversation({
      id: "chat-legacy-frontend",
      metadata: {
        proposedFrontend: {
          systemPrompt: "Saved during migration.",
          sourceIds: ["doc-legacy"],
          temporary: true,
        },
      },
    })
  ...
  it("round-trips frontend-only fields into backend metadata", () => {
